...
export const ROTE_P5_MISSION_MAPS = Object.freeze({
  malachor: planet("malachor", "malachor.png", [
    node("c1", "combat", 51, 15, "Combat Mission", "5x Dark Side characters at Relic 9+", "307,125 → 721,744 TP"),
    node("c2", "combat", 41, 45, "Combat Mission", "5x Dark Side characters at Relic 9+", "307,125 → 721,744 TP"),
    node("c4", "combat", 59, 41, "Eighth + Fifth + Seventh Sister", "5x Dark Side characters at Relic 9+ including Eighth Brother, Fifth Brother, and Seventh Sister", "721,744 TP", { missionId: "malachor-inqs", teamId: "rote-malachor-inqs" }),
    node("c6", "combat", 32, 20, "Combat Mission", "5x Dark Side characters at Relic 9+", "307,125 → 721,744 TP"),
  ...
  vandor: planet("vandor", "vandor.png", [
    node("c1", "fleet", 67, 54, "Fleet Mission", "7★ ships", "1,443,488 TP"),
    node("c2", "combat", 30, 50, "Combat Mission", "5x characters at Relic 9+", "307,125 → 721,744 TP"),
    node("c3", "special", 54, 29, "Young Han + Vandor Chewbacca", "5x characters at Relic 9+ including Young Han Solo and Vandor Chewbacca", "20 Mk III Guild Event Tokens", { missionId: "vandor-yhan", teamId: "rote-vandor" }),
    node("c4", "combat", 70, 24, "Combat Mission", "5x characters at Relic 9+", "307,125 → 721,744 TP"),
    node("c6", "combat", 50, 45, "Jabba the Hutt", "5x characters at Relic 9+ including Jabba the Hutt", "307,125 → 721,744 TP", { missionId: "vandor-jabba", teamId: "rote-jabba" }),
  ...
  kafrene: planet("kafrene", "kafrene.png", [
    node("c1", "fleet", 27, 55, "Fleet Mission", "7★ Light Side ships", "1,443,488 TP"),
    node("c2", "combat", 20, 42, "Cassian Andor + K-2SO", "5x Light Side characters at Relic 9+ including Cassian Andor and K-2SO", "307,125 → 721,744 TP", { missionId: "kafrene-cassian", teamId: "rote-rogue" }),
    node("c3", "combat", 20, 25, "Combat Mission", "5x Light Side characters at Relic 9+", "307,125 → 721,744 TP"),
    node("c4", "combat", 65, 46, "Combat Mission", "5x Light Side characters at Relic 9+", "307,125 → 721,744 TP"),
    node("c6", "combat", 35, 22, "Combat Mission", "5x Light Side characters at Relic 9+", "307,125 → 721,744 TP"),
