-- ROTE history contains real Zeffo mission outcomes, so Zeffo is partial rather than source-pending.
...
where page_key='zeffo';

-- Add Zeffo to the same historical ROTE coverage lane and expose the cumulative observed wins.
