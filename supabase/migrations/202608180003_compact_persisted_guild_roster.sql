...
comment on function public.read_persisted_guild_roster(text) is
  'Returns the canonical persisted Guild roster in the live-roster compatibility shape. Owned units intentionally contain progression only; static catalog metadata remains browser-cached and is merged by existing page models.';
