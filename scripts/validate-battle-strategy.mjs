...
const rex = member("CAPTAINREX", "Captain Rex", [{ id: "master_marksman", name: "Master Marksman", description: "Deal Physical damage to target enemy and Stun them for 1 turn." }]);
...
assert.equal(mandalore.status, "ready", "Mandalore BKM should be ready with BAM faster than BKM");
